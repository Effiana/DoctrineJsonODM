...
namespace Effiana\DoctrineJsonOdm\Bundle\DependencyInjection;
 ...
 */
final class EffianaDoctrineJsonOdmExtension extends Extension implements PrependExtensionInterface
{
    /**
     * {@inheritdoc}
     */
